...
function InnerPlayerDrawer({
  ...
  return (
    <div className={s.container}>
      <div className={s.playerCoinContainer}>

        <a style={{ marginBottom: 'auto' }} onClick={toggleLog} aria-label="View chat log">
          <PlayerCoin
